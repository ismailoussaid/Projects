...
def build_argparser():
    ...
    args.add_argument("-m", "--model", help="C:/Users/Ismail/Documents/Projects/Detect Cars/vehicle_detection/vehicle-detection-adas-0002.xml",
                      required=True, type=str)
    args.add_argument("-i", "--input", help="C:/Users/Ismail/Documents/Projects/Detect Cars/dataset_car_detection",
...
def main():
    ...
    model_bin = "C:/Users/Ismail/Documents/Projects/Detect Cars/vehicle_detection/vehicle-detection-adas-0002.bin"
    ...
    for i in range(n):
        image = cv2.imread(glob.glob(args.input[0]+'/*.jpg')[i])
        ih, iw = image.shape[:-1]
        images_hw.append((ih, iw))
        log.info("File was added: ")
        log.info("        {}".format(args.input[i]))
        if (ih, iw) != (h, w):
            log.warning("Image {} is resized from {} to {}".format(args.input[i], image.shape[:-1], (w, h)))
    ...
    data = {}
    data[input_name] = np.array(images).reshape((1,3,384,672))
    ...
    print(classes)
    for imid in classes:
        tmp_image = cv2.imread(glob.glob(args.input[0]+'/*.jpg')[0])
        for box in boxes[imid]:
            cv2.rectangle(tmp_image, (box[0], box[1]), (box[2], box[3]), (255,0,0), 2)
        cv2.imwrite("/Detect Cars/out.jpg", tmp_image)
        log.info("Image out.jpg created!")
    # -----------------------------------------------------------------------------------------------------
