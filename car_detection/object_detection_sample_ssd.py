...
def build_argparser():
    ...
    args.add_argument("-m", "--model", help="xml_model_path",
                      required=True, type=str)
    args.add_argument("-i", "--input", help="images_path",
...
def main():
    ...
    model_bin = path + "vehicle_detection/vehicle-detection-adas-0002.bin"
    ...
    images_hw = []
    #print(n,h,w,c)
    input = glob.glob(args.input[0]+'/*.jpg')
    for i in range(n):
    ...
    for imid in classes:
        tmp_image = cv2.imread(input[0])
        for box in boxes[imid]:
            cv2.rectangle(tmp_image, (box[0], box[1]), (box[2], box[3]), (255,0,0), 2)
        cv2.imwrite(path+"out_openvino.jpg", tmp_image)
