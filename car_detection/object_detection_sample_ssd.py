...
def main():
    ...
    model_name = args.model[len("C:/Users/Ismail/Documents/Projects/Detect Cars/vehicle_detection/"):].replace('.xml','')
    ...
    if has_video:
        ...
        filenames = sorted(glob.glob(args.input + '/*.jpg'), key=os.path.getmtime)
    ...
    while True:
            ...
            if proposal[2] > 0:
                ...
                if confidence > args.confidence:
                    output.append((xmin, ymin, xmax, ymax, label,
                                   name[len("C:/Users/Ismail/Documents/Projects/Detect Cars/dataset_car_detection/"):], confidence))
                    """if not args.save:
        ...
        for box in output:
            ...
            multiple_append([x1, y1, ws, hs, objects, paths, probas],
                            [box[0], box[1], box[2]-box[0], box[3]-box[1], box[4], box[5], box[6]])
            tab = pd.DataFrame(data=d)
            tab.to_csv(globalize(f"tab_{model_name}.csv"))
